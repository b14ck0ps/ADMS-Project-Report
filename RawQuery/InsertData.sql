...
-- Insert sample data into Manager_Phone table
...
-- Insert sample data into Team_Winning table
...
-- Insert sample data into SocialMedia table
...
-- Insert sample data into ContentCreator table
...
-- Insert sample data into ContentCreator_SocialMedia table
...
-- Insert sample data into ContentCreator_SocialMedia table
INSERT INTOContentCreator_SocialMedia (Ccs_ID, ContentCreator_ID, ContentCreator_Facebook_Link, ContentCreator_Twitter_Link, ContentCreator_Instagram_Link, ContentCreator_Youtube_Link)
...
-- Insert sample data into ContentCreator_Address table
...
-- Insert sample data into ContentCreator_Phone table
...
-- Insert sample data into SocialMedia_Phone table
...
-- Insert sample data into Organization_Phone table
...
-- Insert sample data into Player_Address table
...
-- Insert sample data into PLAYER_SOCIAL_LINK table
...
-- Insert sample data into Player_Phone table
...
-- Insert sample data into Player_Winning table
...
-- Insert sample data into Player_Team table
